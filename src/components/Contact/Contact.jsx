...
//           }}
//         ></div>
//             <div className='absolute top-[97px] left-0 w-full h-[60vh] flex flex-col items-center justify-center text-white text-center px-4 bg-black/40 md:h-[90vh] '>
...
//         {/* Form */}
//         <section className='grid   place-items-center h-screen w-full mt-[-0px]'>
//           <div className='p-7  '>
//           <form
//               action=""
    ...
    <div>
      ...
      <section className="relative w-full h-[60vh] md:h-[90vh]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center px-4 bg-black/40">
          ...
          <p className="text-lg md:text-2xl mt-2">The ultimate aim to guide you towards the future</p>
        </div>
      </section>

      {/* Contact Form */}
      <section className="grid place-items-center w-full my-10">
        <div className="p-7 w-full max-w-4xl">
          <form
            onSubmit={submitHandler}
            className="w-full max-w-4xl bg-gradient-to-r from-teal-400 to-yellow-200 border border-black rounded-md p-4 md:p-10"
          >
            <div className="w-full grid md:grid-cols-2 p-6 gap-3">
              <input
                type="text"
            ...
            <div className="px-6">
              <textarea
                ...
                placeholder="Message towards us"
                rows="4"
                className="w-full border border-red-500 hover:border-green-500 p-2 rounded-md"
              ></textarea>
            </div>
            <div className="flex justify-center">
              <button
                type="submit"
                className="p-2 border border-black mt-5 hover:bg-white hover:text-black rounded-md"
              >
                Submit
              </button>
            </div>
